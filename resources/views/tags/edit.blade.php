        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{env('BASE_URL').'tags'}}" class="btn btn-sm fw-bold btn-primary">
                                ...
                                <div class="col-md-12 pe-lg-10">
                                    ...
                                    <form action="#" class="form mb-15" method="post">
                                        ...
                                        <div class="row g-3 mb-8">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter name" id="product_tag_name"
                                                       value="{{$product_tag->name}}"/>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row g-3 mb-8">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <textarea class="form-control form-control-solid" rows="6"
                                                          id="product_tag_notes"
                                                          placeholder="Tag any additional information here...">{{$product_tag->notes}}</textarea>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <!--begin::Actions-->
                                                <input type="hidden" id="id" value="{{$product_tag->id}}">
...
@section('page_level_scripts')
    <script type="text/javascript">
        $(document).on('click', '#product-tag-save-btn', function (e) {
            e.preventDefault();
            do_post_ajax({
                'api_hook': 'tags/update',
                'data': getProductTagUpdateFormData(),
            });
        });

        function getProductTagUpdateFormData() {
            return {
                'id': $('#id').val(),
