                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="price_source_id"
                                                ...
                                                {!!getDropdownOptions(['model'=>'PriceSource','optional'=>1,'selected_value'=>$product->price_source_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="profit_type_id"
                                                    ...
                                                    class="form-select form-select-solid">
                                                {!!getDropdownOptions(['model'=>'ProfitType','optional'=>1, 'selected_value'=>$product->profile_type_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="vat_id"
                                                    ...
                                                    class="form-select form-select-solid">
                                                {!!getDropdownOptions(['model'=>'Vat','optional'=>1,'selected_value'=>$product->vat_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="number" step="any"
                                                   ...
                                                   value="{{$product->sell_price_inc_vat}}"/>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="product_currency_id"
                                                    ...
                                                    class="form-select form-select-solid">
                                                {!!getDropdownOptions(['model'=>'Currency','selected_value'=>$product->currency_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select
                                                ...
                                                class="form-select form-select-solid">
                                                {!!getDropdownOptions(['model'=>'DrugDirection','optional'=>1,'selected_value'=>$product->drug_direction_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select
                                                ...
                                                {!!getDropdownOptions(['model'=>'LocationType','optional'=>1, 'selected_value'=>$product->location_type_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="product_location_id"
                                                ...
                                                {!!getDropdownOptions(['model'=>'Location','optional'=>1,'selected_value'=>$product->location_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
