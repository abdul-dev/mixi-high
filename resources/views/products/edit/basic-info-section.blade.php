                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select
                                                ...
                                                {!!getDropdownOptions(['model'=>'UnitMeasure','optional'=> $product->unit_measure_id])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select
                                                ...
                                                {!!getDropdownOptions(['model'=>'Category','optional'=> $product->cateogyr])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select id="product_tag_id" name="product_tags[]"
                                                ...
                                                {!!getDropdownOptions(['model'=>'Tag','optional'=> $product->product_tags->pluck('tag_id')->toArray()])!!}
                                            </select>
                                        </div>
                                        <!--end::Col-->
