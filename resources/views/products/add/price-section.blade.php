                                ...
                                <div class="col-md-12 pe-lg-10">
                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="number" step="any" name="price[2]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0.00"
                                                   id="avg_net_price"/>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="number" step="any" name="quantity[3]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0"
                                                   id="avg_net_price"/>
                                        </div>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="number" step="any" name="price[3]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0.00"
                                                   id="avg_net_price"/>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="number" step="any" name="quantity[4]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0"
                                                   id="avg_net_price"/>
                                        </div>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="number" step="any" name="price[4]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0.00"
                                                   id="avg_net_price"/>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-8">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="number" step="any" name="quantity[5]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0"
                                                   id="avg_net_price"/>
                                        </div>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="number" step="any" name="price[5]"
                                                   class="form-control form-control-solid"
                                                   placeholder="0.00"
                                                   id="avg_net_price"/>
                                        </div>
